<div class="d-flex flex-column align-items-stretch flex-shrink-0 col-md-4 col-lg-3">
  <nav class="navbar-dark bg-success bg-opacity-75 text-white">
    <div class="mx-1 p-3 border-bottom">
      <div class="row fs-5 fw-semibold">
        <div class="col-8"><i class="bi bi-person-circle"></i> User</div>
  ...
  <div class="list-group list-group-flush border-bottom scrollarea" role="tablist">
    <a href="#list-1" class="list-group-item list-group-item-action active" aria-current="true" id="list-1-list" data-bs-toggle="list" role="tab">
      ...
      <p class="mb-1">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nam nihil vel, saepe perferendis minima</p>
